...
import com.app.search.twitter.BuildConfig;
...
public final class TwitterApiProvider implements TwitterApi {
    ...
    /**
     * Setup twitter config with api and token
     *
    ...
    /**
     * Search twitter by key
     *
     * @param keyword search key
     * @return list of search twitter with Status Objects
     */
    @Override
    ...
    /**
     * Used for load more with last twitter id
     *
     * @param keyword    search key
     * @param maxTweetId last twit id
     * @return list of search twitter with Status Objects
     */
    @Override
